...
def adding_fractions(str1: str, str2: str) -> str:
    list_number = str1.split('/')
    a1 = int(list_number[0])
    b1 = int(list_number[1])
    list_number = str2.split('/')
    ...
    additional_coefficient = common_denominator//b1
    a1 *= additional_coefficient
    additional_coefficient = common_denominator//b2
    a2 *= additional_coefficient

    return f"{a1 + a2}/{common_denominator}"
